...
export default function Home() {
  ...
  useEffect(() => { if (messages.length > 1 || thinking) bottom.current?.scrollIntoView({ behavior: "smooth" }); }, [messages, thinking]);
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#000", color: "#fff", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ borderBottom: "1px solid #222", padding: "80px 40px", maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
        <div style={{ display: "inline-block", background: "#111", border: "1px solid #333", borderRadius: 999, padding: "4px 16px", fontSize: 11, color: "#aaa", marginBottom: 24, letterSpacing: 2, textTransform: "uppercase" }}>Live on Base Mainnet</div>
        <h1 style={{ fontSize: 52, fontWeight: 700, lineHeight: 1.1, marginBottom: 16, letterSpacing: -1 }}>
          42 Sisters
        </h1>
        <p style={{ color: "#aaa", fontSize: 18, maxWidth: 560, margin: "0 auto 40px", lineHeight: 1.6 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 40 }}>
            {[
              ...
              <div key={s.n}>
                ...
                <p style={{ color: "#aaa", fontSize: 15, lineHeight: 1.6 }}>{s.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ borderTop: "1px solid #222" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 40px" }}>
          ...
          <p style={{ color: "#aaa", marginBottom: 32, fontSize: 15, lineHeight: 1.6 }}>Acquire high-fidelity coherence verdicts and structural audits generated by the Sisters. Pay with USDC via x402. Delivered instantly.</p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
            {[
              ...
              <div key={r.title} style={{ background: "#111", border: "1px solid #222", borderRadius: 12, padding: 24 }}>
                ...
                <p style={{ color: "#aaa", fontSize: 13, lineHeight: 1.6, marginBottom: 16 }}>{r.desc}</p>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ color: "#34d399", fontFamily: "monospace", fontSize: 13 }}>{r.price} USDC</span>
                  <button onClick={() => window.location.href='/oracle'} style={{ border: "1px solid #333", background: "transparent", color: "#aaa", padding: "4px 12px", borderRadius: 6, cursor: "pointer", fontSize: 12 }}>Buy Report</button>
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 40px" }}>
          ...
          <div style={{ border: "1px solid #111", padding: "32px", borderRadius: 12, display: "flex", gap: 32, alignItems: "center", flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 280 }}>
              ...
              <p style={{ color: "#666", fontSize: 15, lineHeight: 1.6, marginBottom: 20 }}>A black-box geometric sanity filter. Test your claims against the real CSDM kernel invariants: Stability, Turbulence, and Curvature.</p>
